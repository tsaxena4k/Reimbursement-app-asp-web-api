...
@Component({
  selector: 'app-category-wise-charts',
  templateUrl: './category-wise-charts.component.html',
  styleUrls: ['./category-wise-charts.component.scss']
})
export class CategoryWiseChartsComponent implements OnInit {
